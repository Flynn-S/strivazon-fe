...
export default function NavBar({ links, title, image }) {
  return (
    <>
      <GridContainer class="grid-container">
        <GridItem as="Nav-Left" class="grid-item">
        ...
        <GridItem as="Nav-Center" class="grid-item">
          <form>
            <CustomInputGroup className="mb-3">
              <InputGroup.Prepend>
                <CustomDropdownButton id="dropdown-basic-button" title="All">
        ...
        <GridItem as="Nav-Right" class="grid-item">
          <h5>3rd Column</h5>
        </GridItem>
